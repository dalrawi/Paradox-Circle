...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { name: @concert.name, start_time: @concert.start_time } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { name: @concert.name, start_time: @concert.start_time } }
